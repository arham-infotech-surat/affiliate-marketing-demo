...
$_POST['subject']                 = 'Job Enquiry form' . ' from: ' . $_SERVER['HTTP_HOST'];
...
//$_POST['cc']                      = 'name1@yourdomain.com,name2@yourdomain.com';
...
$_POST['realname']                = $_POST['frmCandidateName'];

/* Variables normally passed in the form - NO DEFAULTS ASSOCIATES WITH THESE, EXAMPLES ONLY */
$_POST['redirect']                = '_tpl/thankyou.html';
$_POST['required']                = array('frmCandidateName' => 'Name','frmAddress' => 'Address','frmCity' => 'City','email' => 'Email Address','frmTelephone' => 'Telephone','frmNameInstitution' => 'Institution Attended','frmDiploma' => 'Diploma/Certificate/Degree');
$_POST['addToCSV']                = true;
