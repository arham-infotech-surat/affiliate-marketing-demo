...
//$_POST['recipient']               = 'yourname@yourdomain.com';
$_POST['subject']                 = 'Contact Us form' . ' from: ' . $_SERVER['HTTP_HOST'];
