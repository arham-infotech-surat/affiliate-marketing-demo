<header class="site-header navbar-sticky">
    <!-- Topbar-->
    <div class="topbar d-flex justify-content-between" style="position:fixed;width:100%;top:0px;">
      <!-- Logo-->
      <div class="site-branding d-flex"><a class="site-logo align-self-center" href="<?php echo base_url();?>"><img src="<?php echo base_url(); ?>/admin/assets/Uploads/Images/<?php echo $logo[0]['logo_img'];?>" alt="<?php echo $logo[0]['logo_title'];?>"></a></div>
      <!-- Search / Categories-->
          ...
          <div class="search-box d-flex">
            <div class="btn-group categories-btn">
              ...
              <div class="dropdown-menu mega-dropdown">
                <div class="row">
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/01.jpg"><span class="text-gray-dark">Computers &amp; Accessories</span></a></div>
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/02.jpg"><span class="text-gray-dark">Smartphones &amp; Tablets</span></a></div>
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/03.jpg"><span class="text-gray-dark">TV, Video &amp; Audio</span></a></div>
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/04.jpg"><span class="text-gray-dark">Cameras, Photo &amp; Video</span></a></div>
                </div>
                <div class="row">
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/05.jpg"><span class="text-gray-dark">Headphones</span></a></div>
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/06.jpg"><span class="text-gray-dark">Wearable Electronics</span></a></div>
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/07.jpg"><span class="text-gray-dark">Printers &amp; Ink</span></a></div>
                  <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo base_url(); ?>assets/img/shop/header-categories/08.jpg"><span class="text-gray-dark">Video Games</span></a></div>
                </div>
              </div>
            </div>
            <form class="input-group" method="get"><span class="input-group-btn">
                <button type="submit"><i class="icon-search"></i></button></span>
              <input class="form-control" type="search" placeholder="What do you want to buy today? Search retailer or website name" style="border:1px solid #e0e0e0!important;background-color:#fff!important">
            </form>
          </div>
        </div>
      </div>
      ...
      <div class="toolbar d-flex">
        <div class="toolbar-item visible-on-mobile mobile-menu-toggle"><a href="#">
            <div><i class="icon-menu"></i><span class="text-label"></span></div></a></div>
     <!--    <div class="toolbar-item hidden-on-mobile"><a href="#">
            <div><i class="flag-icon"><img src="<?php //echo base_url(); ?>assets/img/flags/EN.png" alt="English"></i><span class="text-label">Eng / Usd</span></div></a>
          <ul class="toolbar-dropdown lang-dropdown">
            ...
            <li><a href="#"><i class="flag-icon"><img src="<?php echo base_url(); ?>assets/img/flags/FR.png" alt="Français"></i>&nbsp;Français</a></li>
            <li><a href="#"><i class="flag-icon"><img src="<?php echo base_url(); ?>assets/img/flags/DE.png" alt="Deutsch"></i>&nbsp;Deutsch</a></li>
            <li><a href="#"><i class="flag-icon"><img src="<?php echo base_url(); ?>assets/img/flags/IT.png" alt="Italiano"></i>&nbsp;Italiano</a></li>
          </ul>
        </div> -->
        <div class="toolbar-item hidden-on-mobile"><a href="product-comparison.html">
            <div><span class="compare-icon"><i class="icon-help-circle"></i></span><span class="text-label">How it Works</span></div></a></div>
        ...
        <!-- <div class="toolbar-item"><a href="cart.html">
          ...
          <div class="toolbar-dropdown cart-dropdown widget-cart hidden-on-mobile">
            ...
            <div class="entry">
              <div class="entry-thumb"><a href="shop-single.html"><img src="<?php echo base_url(); ?>assets/img/shop/widget/06.jpg" alt="Product"></a></div>
              <div class="entry-content">
    ...
    <!-- Navbar-->
    <div class="navbar" style="display: none;position:fixed;width:100%;top:80px;">
      <div class="btn-group categories-btn">
        <button class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"><i class="icon-menu text-lg"></i>&nbsp;Categories</button>
        <div class="dropdown-menu mega-dropdown">
          <div class="row">
        ...
        <ul>
            ...
            <ul class="sub-menu">
              <li class="active has-children"><a href="index.html">Hero Slider</a>
                <ul class="sub-menu w-400 p-0 overflow-hidden">
                  <li><a class="p-0" href="index.html"><img src="<?php echo base_url(); ?>assets/img/banners/home01.jpg" alt="Hero Slider Home"></a></li>
                </ul>
              </li>
              <li class="has-children"><a href="home-featured-categories.html">Categories Grid</a>
                <ul class="sub-menu w-400 p-0 overflow-hidden">
                  <li><a class="p-0" href="home-featured-categories.html"><img src="<?php echo base_url(); ?>assets/img/banners/home02.jpg" alt="Categories Grid Home"></a></li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li class="has-megamenu"><a href="#">Mega Menu</a>
            <ul class="mega-menu">
              ...
              <li><a class="card border-0 bg-secondary rounded-0" href="shop-grid-ls.html"><img class="d-block mx-auto" alt="Samsung Galaxy S9" src="<?php echo base_url(); ?>assets/img/banners/mega-menu.jpg"></a></li>
            </ul>
          </li>
