				...
				<!-- Registration form -->
						<div class="card">
							...
							<?php foreach($result as $row):?>
								<form action="<?php echo base_url();?>Logo/update_logo/<?php echo $row['logo_id'];?>" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Logo Image:</label>
												<input type="file" id="slider-img" class="form-control-uniform-custom" name="logo_img"><br>
												<input type="hidden" id="slider-img" class="form-control-uniform-custom" name="oldimg" value="<?php echo $row['logo_img'];?>"><br>
												<img src="<?php echo base_url();?>assets/Uploads/Images/<?php echo $row['logo_img'];?>" id="slider-img-tag" height="150px" width="400px"><br><br>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Logo Title:</label>
												<input type="text" class="form-control" name="logo_tittle" value="<?php echo $row['logo_tittle'];?>" placeholder="Enter Slider Link">
											</div>
										</div>
									</div>
									...
									<div class="text-left">
										...
										<a href="<?php echo base_url();?>Logo" class="btn" style="margin-left: 10px;background-color: rgba(0,0,0,.5);color:white;">Cancel</a>
									</div>
								</form>
							<?php endforeach ?>
							</div>
