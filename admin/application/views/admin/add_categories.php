...
<head>
	...
	<title>Add Categories | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex" >
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Add Categories</span></p>
				...
				<!-- Registration form -->
						<div class="card">
							...
							<div class="card-body">
								...
								<form action="<?php echo base_url();?>Categories/add_categories" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
									<div class="row">
										<div class="col-md-6">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="file" id="profile-img" class="form-control-uniform-custom" name="cat_img" required><br>
												<img src="<?php echo base_url();?>assets/Uploads/Images/Categories/default.png"  id="profile-img-tag" height="150"  width="250" style="border:1px dashed #ddd;"><br><br>
											</div>
										</div>
									</div>
									...
									<div class="text-left">
										<input type="submit" name="btn_add_category" class="btn" value="Add"  style="background-color: #39cccc;color:white;">
