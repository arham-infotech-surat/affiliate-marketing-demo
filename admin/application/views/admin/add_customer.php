...
<head>
	...
	<title>Add Customer's | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex" >
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Add Customer's</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>Customer" class="btn btn-link btn-float text-default"><i class="icon-eye text-primary"></i><span>View Customers</span></a>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="text-center mb-3">
									...
									<span class="d-block text-muted">Codeigniter - Dynamically Add or Remove input fields using JQuery</span>
								</div>
								...
								<form action="<?php echo base_url();?>Customer/add_customer" method="POST" enctype="multipart/form-data">
	                                <div id="dynamic_field">
	                                    <div class="row">
	                                        <div class="col-sm-6">
	                                            ...
	                                            <input type="text" class="form-control" id="name" placeholder="Enter Customer Name" name="cust_name" autocomplete="off">
	                                        </div>
	                                        <div class="col-sm-6">
	                                            <label class="control-label" for="mobno">Mobile Number:</label>
	                                            <input type="number" class="form-control" id="mobno" placeholder="Enter Mobile Number" name="cust_mobno" autocomplete="off">
	                                        </div>
	                                    </div>
	                                    <div class="row" style="margin-top:10px;">
	                                    	...
	                                    	<div class="col-sm-3">
	                                    		<label class="control-label" for="mobno">GST PAN Number:</label> 
	                                    		<input type="number" class="form-control" id="gst_pan_no" placeholder="Enter GST PAN Number" name="gst_pan_no[]" autocomplete="off">
	                                    	</div>
	                                    	<div class="col-sm-3"> 
	                                    	...
	                                    	<div class="col-sm-2">
	                                    		<label class="control-label" for="mobno">Transport Name:</label>
	                                    		<input type="text" class="form-control" id="transport_name" placeholder="Enter Transport" name="transport_name[]" autocomplete="off">
	                                    	</div>
	                                    	<div class="col-sm-1">
	                                    		<label class="control-label" style="color:#ffffff;">000000</label>
	                                ...
	                                <div class="adjust_btns">
	                                    <input type="submit" name="btn_customer_add" id="submit" class="btn btn-info" value="Submit" />
	                                </div>
	                            </form>
							</div>
						</div>
...
<script type="text/javascript">
    $(document).ready(function(){      
      ...
      $('#add').click(function(){  
           i++;             
           $('#dynamic_field').append('<div id="row'+i+'"><div class="row" style="margin-top:10px;"><div class="col-sm-3"><label class="control-label" for="name">Company Name:</label><input type="text" class="form-control" id="company_name" placeholder="Enter Company Name" name="company_name[]" autocomplete="off"></div><div class="col-sm-3"><label class="control-label" for="mobno">GST PAN Number:</label> <input type="number" class="form-control" id="gst_pan_no" placeholder="Enter GST PAN Number" name="gst_pan_no[]" autocomplete="off"></div><div class="col-sm-3"> <label class="control-label" for="name">Address:</label><input type="text" class="form-control" id="address" placeholder="Enter Address" name="address[]" autocomplete="off"> </div> <div class="col-sm-2"><label class="control-label" for="mobno">Transport Name:</label><input type="text" class="form-control" id="transport_name" placeholder="Enter Transport" name="transport_name[]" autocomplete="off"></div><div class="col-sm-1"><label class="control-label" for="mobno" style="color:white;">Action:</label><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove" style="float:right;"><i class="icon-cross2" style="color:#ffffff;"></i></button></div></div></div>');
     });
