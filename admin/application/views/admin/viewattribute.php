			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex">
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-list"></i> <span class="font-weight-bold">Attribute's list</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>Attributes/add_attribute" class="btn btn-link btn-float text-default"><i class="icon-diff-added text-primary"></i><span>Add Attribute</span></a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						...
						<h6 class="card-title">Attribute's View</h6>
					...
					<table class="table datatable-pagination" id="myTable" width="100%">
						...
						<tbody>
							...
							<tr>
								<td><?php echo $row['atb_name'];?></td>
								<td><?php echo $row['atb_grp_name']; ?></td>
								...
								<td>
									<a href="<?php echo base_url();?>Attributes/edit_attribute/<?php echo $row['attribute_id'];?>" name="project_edit" onclick="return confirm('Are you sure you want to update this Service ?')"><i class="icon-database-edit2 text-success"></i></a>
								</td>	
								<td>
									<a href="<?php echo base_url();?>Attributes/delete_attribute/<?php echo $row['attribute_id'];?>" onclick="return confirm('Are you sure you want to Delete this Attribute?')"><i class="icon-trash text-danger"></i></a>
