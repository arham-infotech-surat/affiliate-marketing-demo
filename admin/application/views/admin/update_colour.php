...
<head>
	...
	<title>Update Colours | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex" >
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Update Colour</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>Colour" class="btn btn-link btn-float text-default"><i class="icon-eye text-primary"></i><span>View Colours</span></a>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="text-center mb-3">
									...
									<h5 class="mb-0">Update Colours</h5>
							...
							<?php foreach($colour as $row):?>
								<form action="<?php echo base_url();?>Colour/update_colour/<?php echo $row['colour_id'];?>" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
                                ...
                                <div class="row">
    								...
    								<div class="col-md-6">
    									<div class="form-group">
											...
											<input type="file" id="profile-img" class="form-control-uniform-custom" name="image"><br>
    										<input type="hidden" value="<?php echo $row['image'];?>" name="oldimage">
    										<img src="<?php echo base_url();?>assets/Uploads/Images/<?php echo $row['image'];?>"  id="profile-img-tag" height="150"  width="250" style="border:1px dashed #ddd;"><br><br>
    									</div>
    								</div>
								</div>
									...
									<div class="text-left">
										...
										<a href="<?php echo base_url();?>Colour" type="submit" name="Cancel"  class="btn" style="margin-left: 10px;background-color: rgba(0,0,0,.5);color:white;">Cancel</a>
									</div>
								</form>
							<?php endforeach ?>
