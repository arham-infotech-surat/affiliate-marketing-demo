...
<head>
	...
	<title>Update Brand | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex" >
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Update Brand</span></p>
				...
				<!-- Registration form -->
						<div class="card">
							...
							<?php foreach($brands as $row):?>
								<form action="<?php echo base_url();?>Brand/update_brand/<?php echo $row['brand_id'];?>" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
									<div class="row">
										<div class="col-md-4">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="file" id="profile-img" class="form-control-uniform-custom" name="brand_img"><br>
												<input type="hidden" id="profile-img" class="form-control-uniform-custom" name="oldimg" value="<?php echo $row['brand_img'];?>"><br>
												<img src="<?php echo base_url();?>assets/Uploads/Images/Brands/<?php echo $row['brand_img'];?>"  id="profile-img-tag" height="150"  width="250" style="border:1px dashed #ddd;"><br><br>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<select class="form-control" name="brand_status">
													...
													<option value="0" <?php if($row['brand_status']=="0") {echo 'selected';}?>>Not Publish</option>
													<option value="1" <?php if($row['brand_status']=="1") {echo 'selected';}?>>Publish</option>
												</select>
											</div>
										</div>
									</div>
