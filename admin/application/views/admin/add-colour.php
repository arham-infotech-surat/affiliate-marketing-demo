...
<head>
	...
	<title>Add Colours | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex" >
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Add Colour</span></p>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="text-center mb-3">
									...
									<h5 class="mb-0">Add Colours</h5>

									<span class="d-block text-muted">All fields are required</span>

								</div>

								<form action="<?php echo base_url();?>Colour/add" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
                                ...
                                <div class="row">
    								...
    								<div class="col-md-6">
    									<div class="form-group">
        									...
        									<img src="<?php echo base_url();?>assets/Uploads/Images/default.png"  id="profile-img-tag" height="150"  width="250" style="border:1px dashed #ddd;"><br><br>
    									</div>
    								</div>
								</div>
