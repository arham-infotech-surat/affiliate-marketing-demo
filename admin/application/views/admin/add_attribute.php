			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex" >
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Add Attribute</span></p>
				...
				<!-- Registration form -->
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form action="<?php echo base_url();?>Attributes/add_attribute" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
    									...
    									<div class="form-group">
    										...
    										<select class="form-control" name="attribute_group_id" value="" required>
    											<?php foreach($attr_grp as $row2):?>
    												...
    												<option value="<?php echo $row2['attribute_group_id'];?>"><?php echo $row2['name'];?></option>
    											<?php endforeach ?>
    										</select>
    									</div>
    								</div>
