			...
			<!-- <div class="content justify-content-center align-items-center"> -->
				...
				<!-- Registration form -->
						...
						<div class="card">
							...
							<?php foreach($attr_grp as $row):?>
								<form action="<?php echo base_url();?>AttributeGroup/update/<?php echo $row['attribute_group_id'];?>" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
                                ...
                                <div class="row">
        							...
        							<div class="col-md-6">
        								<div class="form-group">
        									...
        									<input type="text" class="form-control" name="attribute_group_name" value="<?php echo $row['name'];?>" required>
        								</div>
        							</div>
							
									<div class="col-md-6">
        								<div class="form-group">
        									<label>Attribute Group Status:</label>
									...
									<div class="text-left">
										...
										<a href="<?php echo base_url();?>AttributeGroup" type="submit" name="Cancel"  class="btn" style="margin-left: 10px;background-color: rgba(0,0,0,.5);color:white;">Cancel</a>
