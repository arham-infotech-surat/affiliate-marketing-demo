			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-list"></i> <span class="font-weight-bold">Brand list</span></p>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>

					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="<?php echo base_url();?>Brand/add_brand" class="btn btn-link btn-float text-default"><i class="icon-diff-added text-primary"></i><span>Add Brand</span></a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h6 class="card-title">Brand View</h6>
					...
					<table class="table datatable-pagination" id="myTable" width="100%">
						...
						<tbody>
							...
							<tr>
								<td>
									<?php if(isset($row['brand_img']) && !empty($row['brand_img'])){?>
	  								<image src="<?php echo base_url()."assets/Uploads/Images/Brands/".$row['brand_img'];?>" height="70px" width="70px">
	  								<?php } else {?>
	  								<image src="<?php echo base_url()."assets/Uploads/Images/Brands/default.jpg"?>" height="70px" width="70px">
	  								<?php } ?>
								</td>
								<td><?php echo $row['brand_name'];?></td>
								<td><?php if ($row['brand_status']==0) { echo "<h6><span class='badge badge-danger'>Not Publish</span></h6>"; } else { echo "<h6><span class='badge badge-success'>Publish</span></h6>";}?></td>
					          	<td>
									<a href="<?php echo base_url();?>Brand/edit_brand/<?php echo $row['brand_id'];?>"><i class="icon-database-edit2 text-success"></i></a>
								</td>	
								<td>
									<a href="<?php echo base_url();?>Brand/delete_brand/<?php echo $row['brand_id'];?>" onclick="return confirm('Are you sure you want to Delete this Brand?')"><i class="icon-trash text-danger"></i></a>
								</td>									
						</tr>
						<?php endforeach ?>
						<tfoot>
