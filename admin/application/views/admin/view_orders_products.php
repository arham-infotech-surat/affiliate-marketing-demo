...
<head>
	...
	<title>Products Orders's List</title>
	<!-- Global stylesheets -->
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex">
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-list"></i> <span class="font-weight-bold">Product Orders's list</span></p>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						...
						<h6 class="card-title">Product Order View</h6>
					...
					<table class="table datatable-pagination" id="myTable" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $row['product_colour_id'];?></td>
								<td><?php echo $row['quantity'];?></td>
								<td><?php echo $row['price_per_meter'];?></td>
