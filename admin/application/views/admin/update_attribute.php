...
<head>
	...
	<title>Update Attribute | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex" >
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Update Attribute</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>Attributes" class="btn btn-link btn-float text-default"><i class="icon-eye text-primary"></i><span>View Attributes</span></a>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="text-center mb-3">
									...
									<h5 class="mb-0">Update Attribute</h5>

									<span class="d-block text-muted">All fields are required</span>

								</div>
							<?php foreach($attribute as $row):?>
								<form action="<?php echo base_url();?>Attributes/update_attribute/<?php echo $row['attribute_id'];?>" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
                                ...
                                <div class="row">
        							...
        							<div class="col-md-4">
        								<div class="form-group">
        									...
        									<input type="text" class="form-control" name="attribute_name" value="<?php echo $row['name'];?>" required>
        								</div>
        							</div>
    								...
    								<div class="col-md-4">
    									<div class="form-group">
    										...
    										<select class="form-control" name="attribute_group_id" value="" required>
    											<?php foreach($attr_grp as $row2):?>
    												<option <?php if($row2['attribute_group_id']==$row['attribute_group_id']) {echo 'selected';}?> value="<?php echo $row2['attribute_group_id'];?>" ><?php echo $row2['name'];?></option>
    											<?php endforeach ?>
    										</select>
    									</div>
    								</div>
									...
									<div class="col-md-4">
    									<div class="form-group">
    										...
    										<select class="form-control" name="is_active" value="" required>
    												<option value="1" <?php if($row['is_active']==1) {echo 'selected';}?>>Active</option>
													<option value="0" <?php if($row['is_active']==0) {echo 'selected';}?>>Deactive</option>
    										</select>
    									</div>
    								</div>
								</div>
									...
									<div class="text-left">
										...
										<a href="<?php echo base_url();?>Attributes" type="submit" name="Cancel"  class="btn" style="margin-left: 10px;background-color: rgba(0,0,0,.5);color:white;">Cancel</a>
									</div>
								</form>
							<?php endforeach ?>
