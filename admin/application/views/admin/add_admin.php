			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex" >
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Add Admin's</span></p>
				...
				<!-- Registration form -->
						<div class="card">
							...
							<div class="card-body">
								...
								<form action="<?php echo base_url();?>Admin/create_admin" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
									<div class="row">
										<div class="col-sm-4">
											<label class="control-label" for="admin_name">Admin Name:</label>
											<input type="text" class="form-control" placeholder="Enter Admin Name" name="admin_name" autocomplete="off" required>
										</div>
										
										<div class="col-sm-4">
											<label class="control-label" for="admin_email">Admin Email:</label>
											<input type="email" class="form-control" placeholder="Enter Admin Email" name="admin_email" autocomplete="off" required>
										</div> 
										<div class="col-sm-4">
											<label class="control-label" for="admin_pwd">Admin Password:</label>
											<input type="text" class="form-control" placeholder="Enter Admin Password" name="admin_pwd" autocomplete="off" required>
										</div>
									</div><br>
										...
										<div class="col-sm-4">
											...
											<input type="number" class="form-control" placeholder="Enter Admin Phno" name="admin_phno" autocomplete="off" required>
										</div>
										
										<div class="col-sm-4">
											<label class="control-label" for="admin_email">Permission's:</label><br>
											Create  : <input type="radio" value="1" name="is_create" checked> Yes
													  <input type="radio" value="0" name="is_create"> No<br>
											Read    : <input type="radio" value="1" name="is_read" checked>  Yes
													  <input type="radio" value="0" name="is_read">  No<br>
											Delete  : <input type="radio" value="1" name="is_delete" checked>  Yes
												      <input type="radio" value="0" name="is_delete">  No<br>
											Edit    : <input type="radio" value="1" name="is_edit" checked>  Yes
												      <input type="radio" value="0" name="is_edit">  No<br>
										</div> 
									</div><br>
