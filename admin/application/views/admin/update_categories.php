...
<head>
	...
	<title>Update Categories | <?php echo $this->config->item('web_title'); ?></title>
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex" >
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-file-plus2"></i> <span class="font-weight-bold">Update Categories</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>Categories" class="btn btn-link btn-float text-default"><i class="icon-eye text-primary"></i><span>View Categories</span></a>
				...
				<!-- Registration form -->
						...
						<div class="card">
							...
							<?php foreach($categories as $row):?>
								<form action="<?php echo base_url();?>Categories/update_categories/<?php echo $row['cat_id'];?>" method="POST" enctype="multipart/form-data" class="form-validate-jquery">
                                ...
                                <div class="row">
        							<div class="col-md-4">
        								<div class="form-group">
        									...
        									<input type="text" class="form-control" name="category_name" value="<?php echo $row['cat_name'];?>" placeholder="Enter Category Name" required>
        								</div>
        							</div>
        							<div class="col-md-4">
        								<div class="form-group">
    										<label>Category Image:</label>
											<input type="file" id="profile-img" class="form-control-uniform-custom" name="cat_img"><br>
    										<input type="hidden" value="<?php echo $row['cat_img'];?>" name="oldimage">
    										<img src="<?php echo base_url();?>assets/Uploads/Images/Categories/<?php echo $row['cat_img'];?>"  id="profile-img-tag" height="150"  width="250" style="border:1px dashed #ddd;"><br><br>
    									</div>
        							</div>
									<div class="col-md-4">
        								<div class="form-group">
											...
											<select class="form-control" name="cat_status">
												...
												<option value="0" <?php if($row['cat_status']=="0") {echo 'selected';}?>>Not Publish</option>
												<option value="1" <?php if($row['cat_status']=="1") {echo 'selected';}?>>Publish</option>
											</select>
    									</div>
        							</div>
								</div>
								...
								<div class="text-left">
									<input type="submit" name="update" class="btn" value="Update"  style="background-color: #39cccc;color:white;">

									<a href="<?php echo base_url();?>Categories" type="submit" name="Cancel"  class="btn" style="margin-left: 10px;background-color: rgba(0,0,0,.5);color:white;">Cancel</a>
