			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex">
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-list"></i> <span class="font-weight-bold">Attribute's Group list</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>AttributeGroup/add" class="btn btn-link btn-float text-default"><i class="icon-diff-added text-primary"></i><span>Add Attribute Group</span></a>
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo date('m-d-Y',strtotime($row['date_updated']));?></td>
					          	<td>
									<a href="<?php echo base_url();?>AttributeGroup/edit_attribute_grp/<?php echo $row['attribute_group_id'];?>" name="project_edit" onclick="return confirm('Are you sure you want to update this Service ?')"><i class="icon-database-edit2 text-success"></i></a>
								</td>	
								<td>
									<a href="<?php echo base_url();?>AttributeGroup/delete_attribute_group/<?php echo $row['attribute_group_id'];?>" onclick="return confirm('Are you sure you want to Delete this Attribute Group?')"><i class="icon-trash text-danger"></i></a>
