			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex">
						...
						<p style="font-family: gabriola;font-size: 30px;"><i class="icon-list"></i> <span class="font-weight-bold">Customer's list</span></p>
					...
					<div class="header-elements d-none">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="<?php echo base_url();?>Customer/add_customer" class="btn btn-link btn-float text-default"><i class="icon-diff-added text-primary"></i><span>Add Customers</span></a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						...
						<h6 class="card-title">Service View</h6>
					...
					<table class="table datatable-pagination" id="myTable" width="100%">
						...
						<thead>
							...
							<tr>
								...
								<th>Active</th>
								<th>Deleted</th>
								<th style="text-align:center;">View Addresses</th>
								<th>Date Added</th>
								<th>Date Updated</th>
								<th>Edit</th>
								<th>Delete</th>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center;"><?php if ($row['is_active']==0) { echo "<i class='icon-cancel-circle2' style='color:red;'></i>"; } else { echo "<i class='icon-checkmark-circle2' style='color:green;'></i>";  }?></td>
								<td style="text-align:center;"><?php if ($row['is_deleted']==0) { echo "<i class='icon-cancel-circle2' style='color:red;'></i>"; } else { echo "<i class='icon-checkmark-circle2' style='color:green;'></i>";  }?></td>
								<td style="text-align:center;">
								    <button type="button" id="def" class="btn" data-id="<?php echo $row['customer_id'];?>" data-toggle="modal" data-target="#myModal" style="background-color: #dfdfdf;padding: 0px 5px 0px 5px;"><i class="icon-eye"></i></button>
								</td>
								<td><?php echo date('m-d-Y',strtotime($row['date_added']));?></td>
								<td><?php echo date('m-d-Y',strtotime($row['date_updated']));?></td>
					          	<td>
									<a href="<?php echo base_url();?>Service/edit_service/<?php echo $row['service_id'];?>" name="project_edit" onclick="return confirm('Are you sure you want to update this Service ?')"><i class="icon-database-edit2 text-success"></i></a>
								</td>	
								<td>
									<a href="<?php echo base_url();?>Customer/delete_customer/<?php echo $row['customer_id'];?>" onclick="return confirm('Are you sure you want to Delete this Customer?')"><i class="icon-trash text-danger"></i></a>
